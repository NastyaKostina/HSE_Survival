...
namespace GameHSeSurvival
{
        ...
        class Player:Sprite
    {
        ...
        {
            pms.Move(gameTime, this.Sprite_vector, this.rectangle);
            //MoveEvent?.Invoke(gameTime, this);
            //Collision(gameTime);
        ...
        //    if (keyboardState.IsKeyDown(Keys.Space) && IsOnFirmGround()) { move = -Vector2.UnitY * 32;/*подняли его вверх */ }
        //}
